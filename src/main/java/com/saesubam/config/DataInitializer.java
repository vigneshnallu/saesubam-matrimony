...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (priya != null && karthik != null
            && userInterestRepository.findBySenderAndReceiver(priya, karthik).isEmpty()) {
            ...
            ChatMessage m1 =
                new ChatMessage(karthik, priya, "Hi Priya! Great to connect with you on SaeSubam Matrimony.");
            m1.setTimestamp(java.time.LocalDateTime.now().minusMinutes(12));
            chatMessageRepository.save(m1);

            ChatMessage m2 = new ChatMessage(priya, karthik,
                "Hello Karthik! Nice to meet you. I noticed your profile and liked your professional background.");
            m2.setTimestamp(java.time.LocalDateTime.now().minusMinutes(7));
            chatMessageRepository.save(m2);

            ChatMessage m3 = new ChatMessage(karthik, priya,
                "Thank you! I would love to talk more about our families and interests.");
        ...
        if (priya != null && anand != null && userInterestRepository.findBySenderAndReceiver(priya, anand).isEmpty()) {
            ...
            chatMessageRepository
                .save(new ChatMessage(anand, priya, "Namaste Priya! Glad our families aligned on match preferences."));
        }

        System.out
            .println("✅ Seed matrimony profiles and connected partner chat conversations initialized successfully!");
    }
